      ...
      <b-modal title="Completed Clearance" hide-footer hide-header-close no-close-on-backdrop :visible="printModal">
        <form class="my-2 mx-4">
          <div class="form-group">
            ...
            <ul class="pl-3 mt-2" v-for="(clearance,index) in clearance" :key="index">
              <li><a href="#" @click="openPDF(clearance)">{{ get(clearance, 'semester') }} Semester - School Year {{ get(clearance, 'academic_year') }}</a></li>
            </ul>
          </div>
        </form>
